function cmd(e,o){game.directionsReversed&&("left"===e?e="right":"right"===e?e="left":"up"===e?e="down":"down"===e&&(e="up")),Array.isArray(e)?e.map(e=>cmd(e,o)):game.commands[e.toLowerCase()]=o}function stringToHash(e){var o=0;if(0!=e.length)for(i=0;i<e.length;i++)o=(o<<5)-o+(char=e.charCodeAt(i)),o&=o;return o}function intro(){bigSpacer(),msg("Welcome Adventurer to"),msg("Steal 10 Treasures to Win This Game","title"),spacer(),msg("a game by spaceflounder"),msg("Press ~? if playing for first time!"),spacer()}function msg(e,o){var t,a=document.getElementById("con");a&&((t=document.createElement("div")).className=o||"sep",e=[(lst=e.split("~")).shift(),...lst.map(e=>{return[`<span class="key">${e.slice(0,1)}</span>`,e.slice(1)].join("")})].join(""),t.innerHTML=e,a.append(t),window.scrollTo(0,a.scrollHeight))}function spacer(){msg("","spacer")}function bigSpacer(){msg("","big-spacer")}function clear(){var e=document.getElementById("con");e&&(e.innerHTML="")}function msu(){if(!game.music){const e=["First Snow","Dreams","Plants","Ramen","Endless Grind","Day Trips"];game.track=0,game.music=new Audio(`HoliznaCC0 - ${e[game.track]}.mp3`);setTimeout(()=>{game.music.play(),game.music.addEventListener("ended",()=>{console.log(e[game.track]),game.track+=1,game.track===e.length&&(game.track=0),game.music.src=`HoliznaCC0 - ${e[game.track]}.mp3`,game.music.load(),setTimeout(()=>{game.music.play()},2e3)},!1)},3e3)}}Game.items.chowderSign={shortDesc:"festive sign",initialLocation:"scullery",desc:"A festive sign is posted here. It reads: “Castle Chowder Festival — Down Stairs.” It appears to be a bit loose on the wall.",h:["give me a hint will you","This sign isn't nailed down."],inv:e=>"chowderSign"!==game.item?["remove the festive sign from the wall and take it",()=>{"smellyRoom"===game.location?msg("The sign is stuck where it is."):(takeItem("chowderSign"),"diningHall"===game.things.chowderFestival.location&&(msg("It sounds like they're packing up that festival downstairs to go somewhere else."),game.things.chowderFestival.location=""),refresh())}]:["post the "+e.shortDesc,()=>{"toolRoom"===game.location?msg("There's no place on the wall to post the sign."):(dropItem("chowderSign"),"smellyRoom"===game.location&&(msg(`A great and terrible roar echoes from down the stairs, as if a huge and murderous beast had been 
                        slaughtered by the participants of a chowder festival.`),game.things.chowderFestival.location="clamRoom",game.things.ferociousClam.location="",game.things.clamPearl.location="clamRoom"),refresh())}]},Game.items.screwdriver={shortDesc:"Phillips head screwdriver",initialLocation:"toolRoom",desc:"A Phillips head screwdriver lies here at your feet.",h:["give me a hint will you","Persistance pays off. Keep trying to take the screwdriver."],inv:e=>["take "+e.shortDesc,()=>{game.screwdriver||(game.rooms.toolRoom.attempt?1===game.rooms.toolRoom.attempt?(game.rooms.toolRoom.attempt=2,kill(`You grab the Phillips head screwdriver, and while doing so, you slip and STAB yourself with it! As 
  ...
  below. A narrow window overlooks a charming rose garden far below the castle wall.`),setExitsHeader(["left","right"]),cmd("h",["hint","This room could use some pepper."]),cmd(["up","down"],["walk into wall","Your nose is slightly bent following the attempt."]),cmd("s",["smell drafty room","It smells windy."]),cmd("l",["lick drafty room","You can't lick the wind."]),cmd("f",["feel air","The air is blowing rapidly down into the opening in the floor."]),cmd("c",["climb down chain",()=>go("dragonRoost")]),game.pepper&&cmd("g",["grind pepper",()=>{msg("Great clouds of pepper drift on the air currents down into the opening in the floor."),msg("ACHOOO!"),msg("A firey blast escapes the chamber below! Someone down there can't handle a little pepper in the air!"),"roseGarden"===game.things.rubyRose.location&&game.dragonValve&&(msg(`Through the window, you can make out a bit of flame dancing in the rose garden. It would 
          appear that your actions have managed to scorch a few bushes.`),game.things.rubyRose.location="",game.things.scorchedRubyRose.location="roseGarden",addScore(3),refresh())}]),cmd("right",["enter the maze entrance",()=>go("mazeEntrance")]),cmd("left",["enter scullery",()=>go("scullery")])},Game.rooms.dragonCave=()=>{header("Dragon Cave"),desc("In the shadows is a narrow opening lit by a hot orange glow. Above the opening is very ominous-looking sign in gothic lettering."),setExitsHeader(["up","down"]),cmd(["left","right"],["walk into cave wall","You resist the urge to smack straight into a cave wall."]),cmd(["r","x"],["read sign","The sign reads: “Stop grinding pepper in the dragon's roost, you idiots!”"]),cmd("s",["smell cave","Like fire and old limestone."]),cmd("l",["lick dragon cave","It tastes hot and stony."]),cmd("f",["feel cave","You're the touchy-feely type, aren't you?"]),cmd(["down","i"],["enter the roost",()=>go("dragonRoost")]),cmd("up",["leave the dragon pen",()=>go("clamRoom")])},Game.rooms.dragonRoost=()=>{header("Dragon Roost"),desc(`A vast underground cavern is lit by the gentle orange breath of a massive dragon, big as a football field.
  She seems mostly uninterested in you. A long chain descends from the chamber above.`),setExitsHeader(["up"]),cmd("h",["hint","If you want to get the dragon to breath some fire, this is not the room to be in when it happens."]),cmd(["left","right","down"],["walk into cave wall","You resist the urge to smack straight into a cave wall."]),cmd("b",["yell",()=>{msg("AAAAAOOOOUUUIIIIEEE!!"),msg("“Nice lungs,” says the dragon.")}]),cmd("l",["lick dragon","Even if that were possible, why?"]),cmd("s",["sniff air","The air smells of sulfur and dragon-breath."]),cmd("f",["feel dragon","It's like petting a ginormous gecko."]),cmd("c",["climb up the chain",()=>go("draftyRoom")]),cmd(["up","o"],["exit the roost",()=>go("dragonCave")]),cmd("x",["examine the enormous dragon","It appears as though she's on the verge of taking a nap."]),game.pepper&&cmd("g",["grind pepper",()=>{msg("The smell of pepper mingles with the smoke."),msg("“Ahhh!” cries the dragon, “I'm allergic to pepper!” She holds her long snout. “Ah... AHHHH...”"),kill("The cavern is instantly engulfed in flames!","You have been incinerated","dragonRoost")}]),cmd("a",["attack the enormous dragon",()=>kill("Well, you can guess how that worked out.","You have been smooshed","dragonCave")])},Game.rooms.endGame=()=>{header("You've Won!"),desc(`You are on a tropical island on a beautiful sunny day. It smells vaguely of fresh baked cookies.
  ...
  Under the pipe you can make out: CAUTION! EXHAUST CAN BE IN EXCESS OF 3000 DEGREES IF DRAGON HAS INDIGESTION!`]),cmd("t",["turn valve",()=>{game.dragonValve?(msg("The dragon exhaust valve is now shut."),game.dragonValve=!1):(msg("The valve opens and the smell of smoke fills the air."),game.dragonValve=!0)}]),cmd("down",["follow path",()=>go("sharpRoom")]),cmd("left",["enter shed",()=>go("toolRoom")]),cmd("right",["follow path",()=>go("gardenOfTime")])},Game.rooms.scullery=()=>{header("Scullery"),desc("You're in a filthy old scullery. A narrow stair leads downwards to the dining hall."),setExitsHeader(["right","down"]),cmd("l",["Taste scullery","That seems like a great way to catch an infection."]),cmd("s",["Smell scullery","It smells like something was cooked in here recently."]),cmd("f",["feel wall","You're the touchy-feely type, aren't you?"]),cmd(["left","up"],["plant nose firmly into wall","The filthy scullery wall leaves a greasy smudge on your nose."]),cmd("right",["go through the narrow door",()=>go("draftyRoom")]),cmd("down",["descend stairs",()=>go("diningHall")])},Game.rooms.sculptureGallery=()=>{header("Sculpture Gallery"),game.things.blueprint.turned?(desc("Several beautiful masterpieces of marble stand here, pointing to a door on an otherwise blank wall."),setExitsHeader(["up","down","right"]),cmd(["right","i"],["enter door",()=>go("secretGallery")])):(desc(`Several beautiful masterpieces of marble stand here, pointing at a blank space of wall.
    ...
    land flat on the wall, now in a shuffled order.`);for(const e of[game.things.blueDoor,game.things.redDoor,game.things.greenDoor])"hallOne"===e.location?e.location="hallThree":"hallTwo"===e.location?e.location="hallOne":"hallThree"===e.location&&(e.location="hallTwo");refresh()}]),cmd("left",["walk hallway",()=>go("hallTwo")])},Game.things.blueDoor={desc:"A large blue door is here, beckoning you to come in.",location:"hallTwo","i up":["enter the door",()=>{msg("You enter the door and climb the stairs beyond."),go("pricelessMapRoom")}]},Game.things.blueprint={desc:"On the table is a blueprint of the very castle you've been exploring.",location:"blueprintDesk","r x":["read blueprints",()=>{game.things.blueprint.turned?msg("It looks like the castle you've been exploring, but turned around."):msg(`It looks pretty much like the castle you've been exploring. You 
            ...
            affected future events.`))}],inv:["take blueprint",()=>{msg("Taken."),kill(`FOOM! As you steal the blueprints for the castle, you create a big swirling
    ...
    the Faberge pencil.`],h:["give me a hint will you","Maybe you should just take the spike and see what happens."],inv:["carefully take diamond spike",()=>{msg("You very carefully remove the diamond spike."),msg("Taken."),addScore(5),msg(`A cheerful little teddy bear with an enormous satchel appears and grabs the diamond spike. 
        “Good job!” he says with a smile. “I'll just drop this treasure into your safe deposit box for you.”`),game.things.diamondSpike.location="",refresh(),depositTreasure("diamondSpike")}]},Game.things.doorbell={location:"frontDoor",desc:"Next to the door is a cheery little doorbell.",x:["examine doorbell","It has a gentle yellow glow."],"i up":["enter castle","You should open the door somehow first."],h:["give me a hint will you","Don't eat the ice cream."],p:["push doorbell",()=>{msg("A merry chime rings from inside the castle."),msg(`Moments later, a staticky speaker comes to life inside the 
        ...
        emerges holding a delicious ice cream cone.`),msg("Press ~l to lick, ~s to sniff, or ~p to push the ice cream cone away.","sub"),game.commands={},cmd("help",["help","Press ~l to lick, ~s to sniff, or ~s to push the ice cream cone away."]),cmd("l",["enjoy delicious ice cream",()=>{kill(`You take a hearty lick off the cone. It is the best
    ...
    answer my riddle. If a tree falls in the forest, what time will the 3 o' clock train to Chattanooga arrive?”`,location:"griffinRoom",h:["give me a hint will you","If you make a friend in the castle with a gift for riddles, they might be helpful here."],x:["examine griffin",()=>{msg(`"Studying me to find some weakness in my riddle?" asks the griffin. "Well, it won't work."`)}],l:["lick griffin","“Would you cut that out please?” says the griffin, thoroughly grossed out."],f:["feel griffin","You give the griffin a few friendly pets and he purrs contentedly."],a:["attack griffin",()=>kill("SLASH! The griffin ENDS you with one swipe of his claws!","You didn't make the cut","griffinRoom")],1:["Answer 1 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],2:["Answer 2 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],3:["Answer 3 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],4:["Answer 4 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],5:["Answer 5 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],6:["Answer 6 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],7:["Answer 7 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],8:["Answer 8 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],9:["Answer 9 o' clock ",()=>{kill("“Wrong!” cries the griffin. He shoots lasers from his eyes and you are fried to a crisp!","You are now charcoal briquettes","griffinRoom")}],b:["scream in frustration",'"Ha!" laughs griffin. "My riddle is causing you no small distress, I see."']},Game.things.heavyThrone={desc:"An incredibly valuable golden throne is here! It isn't nailed down so it must be yours for the taking!",location:"throneRoom",x:["examine throne","It must weigh a ton."],f:["feel throne","It feels valuable."],h:["give me a hint will you","It's time for you to take the throne-literally."],inv:["take throne",()=>{msg("Your lumbar complains about you stealing the ridiculously heavy throne!"),msg("Taken."),addScore(5),msg(`A cheerful little teddy bear with an enormous satchel appears and grabs the throne with considerable effort. 
        ...
        “Good job!” he says with a smile. “I'll just drop this treasure into your safe deposit box for you.”`),game.things.treasureMap.location="",refresh(),depositTreasure("treasureMap")}]};var game={};const resetGame=()=>{game=null,game={...Game},setItems(),intro(),go("startRoom")},cleanUpKey=e=>"inv"===e?"period":e;function createCommonResponses(){game.commands={},game.printPlayerHelp=printPlayerHelp,cmd("q",["quit game",()=>{msg("Are you sure you want to quit? Hit ~y or ~n."),game.commands={},cmd("help",["help","Please hit ~y or ~n."]),cmd("y",["I am done",()=>{clear(),resetGame()}]),cmd("n",["keep playing",()=>go(game.location)])}]),cmd("space",["look around",look]),cmd("l",["I want to lick something","You taste nothing special."]),cmd("s",["sniff sniff sniff","You smell nothing special."]),cmd("r",["do some reading","There's nothing here to read."]),cmd("x",["examine (something)","There is nothing here worth examining."]),cmd("h",["give me a hint will you","No hints in the current room."]),cmd("f",["feel around","You feel nothing special."]),cmd("inv",["can I take anything in here","There's nothing here worth taking."]),cmd("up",["move ahead","You can't go that way."]),cmd("down",["move backwards","You can't go that way."]),cmd("right",["move right","You can't go that way."]),cmd("left",["move left","You can't go that way."]),cmd("c",["I want to climb something","Climbing here gets you nowhere."]),cmd("i",["enter","There's nothing to enter."]),cmd("o",["exit","There's nothing to exit."]),cmd("y",["yank","There's nothing here to yank."]),cmd("p",["push","There's nothing here to push."]),cmd("b",["yell","Your loud hollering accomplishes nothing."]),game.pepper&&cmd("g",["grind pepper","Your surroundings are now more peppery."]),game.whistle&&cmd("w",["blow whistle","A shrill tone reverberates in the air."]),cmd("a",["attack","There's nothing here to attack."]),cmd("t",["turn","There's nothing here worth rotating."]),cmd("help",["help",()=>game.printPlayerHelp()]),cmd("score",["score",()=>msg(ranking())])}function desc(e){game.desc=e}function look(){refresh(),msg(game.header,"room"),msg(game.desc),handleThingsDesc(game.things),handleItemsDesc(),game.item&&msg(`You're carrying a ${game.items[game.item].shortDesc}.`)}function setExitsHeader(e){e?(game.directionsReversed&&(e=e.map(e=>"left"===e?"right":"right"===e?"left":"up"===e?"down":"down"===e?"up":void 0)),game.headerExits=e.sort().map(e=>{switch(e){case"up":return"↑";case"left":return"←";case"right":return"→";default:return"↓"}}).join(" ")):game.headerExits=void 0}function header(e){game.header=e}function addScore(e){msg(1<e?`[Your score has gone up ${e} points.]`:`[Your score has gone up ${e} point.]`),game.score+=e}function updateHeaderBar(){var e,o,t=document.getElementById("header");t&&(o=document.createElement("div"),e=document.createElement("div"),t.innerHTML="",o.append(game.header),o.className="exits",e.className="exits",e.append("Score "+game.score),t.appendChild(o),game.headerExits&&((o=document.createElement("div")).className="exits",o.append("Exits "+game.headerExits),t.appendChild(o)),t.appendChild(e))}function printPlayerHelp(){let e="",o="";game.pepper&&(e="<td>~g To Grind some pepper</td>"),game.whistle&&(o="<td>~w To blow the whistle</td>"),msg(`
    ...
    `)}function handleItemsCommands(){var e=["inv"],o=game.location,o=game.rooms[o];if(o.item){o=o.item;const t=game.items[o];e.map(e=>{t[e]&&cmd(e,t[e](t))})}if(game.item){o=game.item;const a=game.items[o];e.map(e=>{"t"!==e&&a[e]&&cmd(e,a[e](a))})}}function handleItemsDesc(){var e=game.location,e=game.rooms[e];e.item&&(e=e.item,msg(game.items[e].desc))}function setItems(){for(const o of Object.keys(game.items)){var e=game.items[o];e.initialLocation&&(e=e.initialLocation,game.rooms[e].item||(game.rooms[e].item=o))}}function takeItem(e,o){var t=game.location,t=game.rooms[t];o=o||"Taken.",t.item===e&&(game.item?msg("My hands are full."):(game.item=t.item,t.item=null,msg(o),refresh()))}function dropItem(e,o){var t=game.location,t=game.rooms[t];o=o||"Dropped.",t.item||(game.item?(t.item=game.item,game.item=null,refresh(),msg(o)):msg(`You can't drop the ${game.items[e].shortDesc} with
            the ${game.items[t.item].shortDesc} here.`))}function taunt(){var e=["Well, that was rich.","Don't worry, that wasn't the worst game I've ever seen. Maybe the second worst.","Thank you for playing. I've enjoyed watching you, for the most part.","Thank you for playing. Usually I don't recommend a walkthrough, but in your case...","Next time, try saying xyzzy, that always does something.","Somewhere, a famous white house with a mailbox out front is waiting for you.","Seeing this game would make Floyd die all over again.","Next time, try saving your game.","Not bad. Not good, but, well... Actually yeah that was pretty bad.","Are you new to adventure games? Wait, don't answer that."];return shuffle(e),e[0]}function kill(e,o,t){game.commands={},msg(e),msg(o,"epitaph"),msg(taunt()),msg(ranking()),msg("Would you like to try again?"),msg("[Press Y to try again or N to quit.]"),cmd("help",["help","Press Y to try again or N to quit."]),cmd("y",["yes",()=>{msg("Okay... I'll do my best... Here goes nothing..."),go(t)}]),cmd("n",["no",()=>{window.location.reload()}])}function go(e){setExitsHeader(null),createCommonResponses(),game.location=e,game.rooms[e](),look()}function ranking(){var e=["clueless tourist","inept explorer","semi-competent burglar","skilled treasure-hunter","master adventurer"],o=game.score,t=o/65,t=Math.floor((1<t?1:t)*e.length),a=game.treasure??{};return`So far, you've collected ${Object.keys(a).length} treasures. You've scored ${o} out of 65, earning you the rank of ${e[t]}.`}function refresh(){createCommonResponses(),game.rooms[game.location](),handleThingsCommands(game.things),handleItemsCommands(),updateHeaderBar()}window.addEventListener("load",()=>{resetGame(),window.addEventListener("keydown",e=>{e.preventDefault()}),window.addEventListener("keyup",e=>{let o=e.key.toLowerCase();var t;" "===o?o="space":"#"===o?o="transcript":"?"===o?o="help":"$"===o?o="score":"."===o?o="inv":"arrowleft"===o?o="left":"arrowright"===o?o="right":"arrowup"===o?o="up":"arrowdown"===o&&(o="down"),o&&(game.commands[o]?([e,t]=game.commands[o],game.transcript?msg(`${e} (${cleanUpKey(o)} key)`,"res"):msg(""+e,"res"),game.turns+=1,"string"==typeof t?msg(t):t(),updateHeaderBar()):"transcript"===o&&(game.transcript?(msg("Transcript mode off."),game.transcript=!1):(game.transcript=!0,msg("Transcript mode on."))))})});const shuffle=e=>{let o=e.length,t;for(;0!=o;)t=Math.floor(Math.random()*o),o--,[e[o],e[t]]=[e[t],e[o]];return e},roll=e=>e>=Math.floor(100*Math.random()),countdown=e=>1<e.length?e.pop():e[0],pick=e=>{var o=`p{${stringToHash(e.join("-"))}}`;return game[o]&&game[o]?.length||(game[o]=shuffle([...e])),game[o].pop()};function handleThingsCommands(t){const a=["desc","active","location"];Object.keys(t).map(e=>{const o=t[e];o.location===game.location&&Object.keys(o).filter(e=>-1===a.indexOf(e)).map(e=>{-1<e.indexOf(" ")?cmd(e.split(" "),o[e]):cmd(e,o[e])})})}function handleThingsDesc(o){Object.keys(o).map(e=>{e=o[e];e.location===game.location&&e.desc&&msg(e.desc,"con")})}function depositTreasure(e){game.treasure[e]||(game.treasure[e]=!0),10===Object.keys(game.treasure).length&&(msg(`“Well done!” cries another little teddy bear with a disproportionally huge mallet behind his back. “That's the last treasure!
