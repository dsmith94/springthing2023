let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
  ...
  `,talk:()=>{w(`
    ...
    `),c("Inspect the chests",()=>{x("foundHiddenChest",!0),w(`
    ...
    `),c('"Bixby, show me the crime scene."',()=>{w(`
        ...
        `),b("interviewWerstrom")()}),c('"Bixby, I will interview Mr. Thurman."',()=>{w(`
            "Very well."
        `),b("interviewThurman")()}),c('"What do you think, Bixby?"',()=>{w('"What do you think, Bixby?" I asked.'),w([`"You're the China Doll," he said with a note of derision. "Aren't you supposed to have the 
  ...
  north. "You've heard of Captain Roger Bennett?"
    ...
    `),c('"Always pleasant to see you as well, Bixby."',()=>{w('"Always pleasant to see you as well, Bixby," I grumbled.'),b("intro8")()}),c('"Hmm. What is your theory, Mr. Bixby?"',()=>{w('I was more curious than offended. "Hmm. What is your theory, Mr. Bixby?"'),b("intro8")()})},Game.intro8=()=>{w(`
