let n=!1;const t=()=>{if(!n){const a=document.createElement("div"),o=(a.className="menu",document.createElement("div"));o.style=`
      ...
      align-items: center;
    `;let e=[];d.map&&(e=d.map.sort().filter(e=>d[e]?.location!==d.currentLocationName)).map(t=>{var e;d[t].location&&((e=document.createElement("button")).innerText=d[t].name,e.style="width: 80vw;",e.onclick=()=>{const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,n=!1,a.remove(),c(),m(),C(d[t].location)(),document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},o.appendChild(e))});var t=document.createElement("button");t.style="aspect-ratio: 1; font-size: 32pt; font-weight: bold; width: 64px; height: 64px;",t.innerText="⤒",t.onclick=()=>{n=!1,a.remove();const e=document.createElement("div");e.className="outMenu",e.innerHTML=a.innerHTML,document.body.appendChild(e),setTimeout(()=>{e.remove()},400)},0<e.length&&(o.appendChild(t),a.appendChild(o),document.body.appendChild(a))}};let d={},h={};const l=(e,t=!1)=>{let a=0;const o=t?"div":"p";return e.split("\n").map(e=>e.trim()).join("\n").split("\n\n").filter(e=>""!==e).map(e=>`<${o}>${(o=>{const n={quote:!0,bold:!0,italic:!0};var e=(e,t,a)=>{for(;-1<o.indexOf(e);)o=n[t]?o.replace(e,`<${a}>`):o.replace(e,`</${a}>`),n[t]=!n[t]},t=(t,a)=>o=o.split("\n").map(e=>0===e.trimStart().indexOf(t)?`<${a}>${e.replace(t,"")}</${a}>`:e).join("\n");for(t("#### ","h4"),t("### ","h3"),t("## ","h2"),t("# ","h1");-1<o.indexOf("[[");)o=a%2==0?o.replace("[[","&ldquo;"):o.replace("[[","&lsquo;"),a+=1;for(;-1<o.indexOf("]]");)--a,o=a%2==0?o.replace("]]","&rdquo;"):o.replace("]]","&rsquo;");for(e("``","quote","q"),e('"',"quote","q"),e("**","bold","b"),e("*","italic","i");-1<o.indexOf("'");)o=o.replace("'","&rsquo;");return o=o.trim()})(e)}</${o}>`).join("")};function o(e){var t=0;if(0!=e.length)for(i=0;i<e.length;i++)t=(t<<5)-t+(char=e.charCodeAt(i)),t&=t;return t}Game.Stockford={name:"the man with the pewter cup",location:"insideClub",hasMet:!1,notMet:()=>`
    ...
    `,talk:()=>{p("Stockford"),I(`
        ...
        `),f('"Not precisely, but I work with them."',()=>{I(`
            ...
            `),g("gettingDeeper")}),f('"Of course not. Who do you take me for?"',()=>{I(`
            
            "Of course not. Who do you take me for?" I said.

            He smiled as though he knew my secret. "Of course you don't."
            
            `),g("gettingDeeper")}),f('"Scotland Yard? The police force?"',()=>{I(`
            
            "Scotland Yard? The police force?" I said. "What sort of trouble are you in?"

            "The very worst—I daresay a matter of life and death."
            
            `),g("gettingDeeper")}),v('"Well, it has been a pleasure to meet you. Good-bye."')},scared:()=>{I(`"I've aided you enough," he said. "Now go get me the help you promised. I'll be here."`),v('"Thank you, Mr Stockford."')},moreDeep:()=>{I(`
        ...
        `),f(`"But Hob didn't stay in St. Helena, did he?"`,()=>{I(`
            ...
            `),S("stockfordDoomed",1),g("scared")}),f('"And what came of Hob after that?"',()=>{I(`
            ...
            `),S("stockfordDoomed",1),g("scared")})},gettingDeeper:()=>{I(`
        ...
        `),f('"How long have you been a member?"',()=>{I(`

            "How long have you been a member?" I asked.
            
            "Since Roger recruited me," said Stockford.
            
            `),g("moreDeep")}),f('"Did you know Captain Roger Bennett?"',()=>{I(`
            
            "Did you know Captain Roger Bennett?" I asked.

            "Of course I did," said Stockford. "He recruited me."
            `),g("moreDeep")}),v('"Stay here while I get help."')}},Game.cabbie=()=>{I(`

    ${B(['The cabbie waited for me to take a seat. "Where to, miss?"',"I sat in the hansom and the cabbie turned to me.",`"Where ar' we headed today?" The cabbie impatiently waited for me to get in.`])}

    `),k("Enter a place name or address, like *11 West India Dock Road*.",t=>{var e=e=>-1<t.indexOf(e),a=()=>B([`"Of course, ma'am."`,'"Righty."','"Very good, miss."','"Right-o, miss."']);e("dock")||e("limeh")||e("chinat")?I("I don't need to go home yet."):e("spaul")||e("wareh")?(I(a()),f("One ride later...",C("outsideWarehouse"))):e("surr")?(I(a()),f("One ride later...",C("surrey"))):e("astl")||e("circus")?(I(a()),f("One ride later...",C("circus"))):e("scotlandy")?(I(`
            
            ${a()}
            
            `),f("One ride later...",C("scotlandYard"))):e("manor")?I(`
        ...
        ${B([`"'Fraid I don't know how to get there," said the cabbie.`,'"Never heard of that place. Is it in London?"',`"I don't understand where you want me to take you," said the cabbie.`])}
    ...
    `),e("Open the door","To no avail, the door is locked tight."),f("Knock on the door",()=>{I([`
        ...
        `]),f(`"I'm here to see someone, on official business."`,()=>{I(`
            
              "You don't look much official," said the man. "Who are you here to see?"  
            
            `),k("Enter the name of a person, like *Bixby*.",e=>{-1<e.indexOf("aldi")?3===H("stockfordDoomed")?f(`"He's in here," said the man.`,C("insideCircus")):I(`
                        
                            "He's not present," said the man. "Come back later."
                        
                        `):I(`

                ${B([`"Never heard of 'im," said the man.`,'"Find someone else to pester,"  said the man.',`"That bloke doesn't work here," said the man.`])}
        ...
        `),f('"Clearly I have the wrong address. Thank you, sir."',()=>{I(`
            
            "Clearly I have the wrong address. Thank you, sir."

            He responded with a weary hurumph.
            
            `)})}),f("Catch a cab",C("cabbie"))},Game.crimeScene=()=>{I(`
    ...
    `),e("Examine the chests",()=>{S("foundHiddenChest",!0),I(`
    ...
    `)}),H("foundHiddenChest")&&f("Examine the unusual chest",`
    ...
    *ASTLEY RT*
    ...
    `),f("Exit the crime scene",C("manorHouseFoyer"))},Game.insideCircus=()=>{I([`
    ...
    `]),f("Investigate trunk",()=>{I(`
        ...
        `),f("Look closer",()=>{I(`
            ...
            `),e('"Release me!"',()=>{I(`
                ...
                `),e('"As I am locked in a box, I believe you have the advantage on me?"',()=>{I(`
                    ...
                    `),f('"The Walrus? What are you talking about?"',()=>{I(`
                    ...
                    `),f('"That still makes you a killer."',()=>{I(`
                        ...
                        `)}),f('"Perhaps. But the courts should decide."',()=>{I(`
  ...
  `),f(`"I believe we've found our rat,"`,()=>{I(`
    ...
    `),e("Investigate the disturbed soil",()=>{S("hob",!0),I(`
        ...
        `),T("*We execute betrayers*"),T("*Hob remembers*"),T("*Your time is up*"),T(" "),I(`
        
        Each was flourished with a signature black India-ink scrawl of a
        walrus.
        
        `)}),f("Return to the manor house",C("manorHouseFoyer"))},Game.manorHouseFoyer=()=>{var e=H("hob")&&H("foundHiddenChest")&&H("foundBankAddress");e?I([`
    ...
    `),f('"Bixby, show me the crime scene."',()=>{C("crimeScene")()}),f('"Bixby, I will interview Mrs. Werstrom."',()=>{C("talkToWerstrom")()}),f('"Bixby, I will interview Mr. Thurman."',()=>{C("talkToThurman")()}),H("roseGarden")&&f(`"I'd like to investigate the grounds."`,()=>{b("manorGrounds")&&I(`"Of course," said Bixby, handing me a candle.
        "It's very dark tonight, so you'll need a light."`),C("manorGrounds")()}),f('"What do you think, Bixby?"',()=>{I('"What do you think, Bixby?" I asked.'),I([`"You're the China Doll," he said with no small derision. "Are you not the 
            nimblest mind in Europe?"`,'He shrugged. "Why are *you* asking me?"',"Bixby only scowled at the question."])}),e&&f("Depart for Limehouse",()=>{I(`
        ...
        `),f("The next morning...",C("streetsOfLondon"))})},Game.museum=()=>{I(`
    
    Bixby stared at me expectantly.
    
    `),k("Give Bixby a person or topic to research, like *Black Walrus*",t=>{var e=e=>-1<t.indexOf(e);e("walr")?I(`
        ...
        `):I(`"Haven't got anything on that, I'm afraid," said Bixby.`)}),f("Leave the museum",C("cabbie"))},Game.outsideWarehouse=()=>{I(`

    The warehouse was a peculiarly sinister thorn in the twisted bramble of shadowy brick buildings.

    `),H("enteredWarehouse")||f("Enter the warehouse",()=>{S("enteredWarehouse",!0),I(`
	...
	`),f('"An educated citizen?"',`

	"Don't matter!" he said, pointing at the door. "Out!"

	`)}),H("enteredWarehouse")&&f("Enter the warehouse",`

    "What did I tell you before?" shouted the brute as I entered. "Your kind isn't allowed in this place!"

    `),H("stockfordDoomed")||(H("boughtFlower")||I([`
    ...
    `,`"I'm certain a flower would brighten your day," said the woman, an insistent tone in her voice.`]),H("boughtFlower")||f("Purchase a flower",()=>{S("boughtFlower",!0),I(`
    ...
    `),f(`"A certain recently deceased sea captain, as if you didn't know."`,()=>{I(`
	...
	`),f('"What will your surveillance cost me today?"',`
...
"Captain Bennett was a traitor more than once in his life. Investigating the affairs of the Black Walrus Society can be dangerous, if you get my meaning." She spoke in a lower tone, close to a whisper. "That's why I don't know anything."
	...
	`),f('"A man is dead and I have no time for games."',`
	...
	`),f('"And what will your surveillance cost me today?"',`
	...
	`)})}),f("Catch a cab",C("cabbie")))},Game.scotlandYard=()=>{I(`
    ...
    `),2===H("stockfordDoomed")?f("Find Gould",()=>{const e=()=>{I(`
        ...
        `),f('"Hob has escaped."',()=>{I(`
          ...
          `),f('"Precisely."',()=>{I(`
            ...
            `),a()}),f('"Of course you blind fool."',()=>{I(`
      ...
      `),f('"Of course I am."',()=>{I(`
        ...
        `),f("Follow Gould down the stairs into a dark passage",()=>{I(`
            ...
            `),f("Continue downstairs",()=>{I(`
              ...
              `),f("Let's get to work",C("museum"))})})}),b("scotlandYard")&&H("stockfordDoomed")<2&&f("Enter the museum",C("museum"))),f("Catch a cab",C("cabbie"))},Game.start=()=>{I(`
    ...
    `),f("First Time Playing",C("firstTime")),f("Start",C("intro1")),f("I've played before, take me straight to the crime scene",C("manorHouseFoyer"))},Game.firstTime=()=>{I(`

    ### Tips for First Time Detectives
    `),T("❧ Write down every clue during your investigation. The best crime-solvers use a pen and paper!"),T("❧ Talk to everyone. It may be helpful to talk to some characters more than once."),T(`❧ Near the end of the story, you will be asked to identify the villain.
    It is technically possible to lock yourself out of victory, so be sure you've caught the right suspect.`),f("I'm ready to solve the mystery",C("start"))},Game.intro1=()=>{I(`
    ...
    `),f("Open the door",C("intro2")),f("Wait",C("intro1_1"))},Game.intro1_1=()=>{I(`

    The rap on my door came again, more insistent this time.
    
    `),f("Open the door",C("intro2")),f("Wait",C("intro1_1"))},Game.intro2=()=>{I(`
    ...
    `),f('"This is scarcely a decent hour."',()=>{I(`
  ...
  on the way? I have a hansom waiting for us." 
    ...
    `),f('"I will exact my usual fee, of course."',C("intro4"))},Game.intro3_1=()=>{I(`
          
  "More sparks of keen wit," said Gould with a vexed sigh. "Come, we have work to do. I have a hansom waiting for us." 

    `),f('"I will exact my usual fee, of course."',C("intro4"))},Game.intro4=()=>{I(`
  ...
  north. "You've heard of Captain Roger Bennett?"
    ...
    `),f(`"Captain Bennett, of the Queen's Navy?"`,()=>{I(`
    ...
    `),f('"Was the door still locked?"',()=>{I(`
        ...
        `),f('"I assume the crime scene is as you found it."',C("intro5"))})}),f(`"I've heard of him."`,()=>{I(`
    ...
    `),f('"And the door was still locked."',()=>{I(`
        ...
        `),f('"I assume the crime scene is as you found it."',C("intro5"))})})},Game.intro5=()=>{I(`
    ...
    `),f('"Excellent!"',C("intro6"))},Game.intro6=()=>{I(`
    ...
    `),f("Proceed to the manor house",C("intro7"))},Game.intro7=()=>{I(`
    ...
    `),f('"Most pleased to see you as well, Bixby."',()=>{I('"Most pleased to see you as well, Bixby," I grumbled.'),C("intro8")()}),f('"Hmm. What is your theory, Mr. Bixby?"',()=>{I('I was more curious than offended. "Hmm. What is your theory, Mr. Bixby?"'),C("intro8")()})},Game.intro8=()=>{I(`
    ...
    `),f('"Thank you, Chief Inspector. I shall examine the crime scene in your absence."',()=>{I(`
      ...
      `),C("manorHouseFoyer")()}),f('"Can you put Officer Bixby under my authority on a more permanent basis?"',()=>{I(`
      ...
      `),C("manorHouseFoyer")()})})},Game.streetsOfLondon=()=>{I(`
    ...
    `),f("Call a cab",C("cabbie"))},Game.surrey=()=>{1!==H("stockfordDoomed")&&I(`
    ...
    `),1===H("stockfordDoomed")&&(I(`
        ...
        `),S("stockfordDoomed",2)),f("Enter the club",C("insideClub")),f("Catch a cab",C("cabbie"))},Game.insideClub=()=>{I(`
    ...
    `),f("Leave the Surrey Club",C("surrey"))},Game.talkToThurman=()=>{I(`
    ...
    "Did you discover the body?" I asked.
      ...
      `),f('"Did Captain Bennett have any enemies?"',[`
    ...
    `]),f(`"Was there any reason to believe Captain Bennett's life was under threat?"`,()=>{S("roseGarden",!0),I([`
    ...
    `])}),f('"Thank you for your assistance, Mr. Thurman."',C("manorHouseFoyer"))},Game.talkToWerstrom=()=>{I(`
      ...
      `]),e('"Can you describe the events leading up to the murder?"',`
        ...
        `),f(`"Was there any reason to believe Captain Bennett's life was under threat?"`,()=>{S("foundBankAddress",!0),I([`
      ...
      `])}),f('"Thank you, Mrs. Werstrom."',C("manorHouseFoyer"))},window.addEventListener("load",()=>{var e;d={...Game},(e=document.createElement("div")).className="topBar",e.onclick=t,document.body.appendChild(e),m(),C("cabbie")()}),()=>{const e=document.getElementsByTagName("button")[0],t=document.getElementsByTagName("input")[0];setTimeout(()=>{t?t.focus():e&&e.focus()},100)}),e=(e,t)=>{const a="d"+o(e);d[a]||f(e,()=>{d[a]=!0,"function"==typeof t?t():I(t)})};const c=()=>{document.getElementsByClassName("main")[0].remove(),d.buttonCount=0},m=()=>{let e=document.getElementsByClassName("topRoot")[0];var t=document.createElement("div"),a=document.createElement("div"),o=document.createElement("btns");e||((e=document.createElement("div")).className="topRoot",document.body.appendChild(e)),e.appendChild(t),t.className="main",t.id="main",a.className="page",a.id="page",o.className="btns",o.id="btns",e.appendChild(t),t.appendChild(a),t.appendChild(o)},y=()=>{!d.env||!d.isTalking&&d.buttonCount||I(d.env())},f=(o,n,e)=>{var t=document.getElementById("btns");if(!(t&&o&&n))throw"Button could not be constructed! With options: "+o;d.buttonCount||(d.buttonCount=0),d.buttonCount+=1,o=o.trim();var a=document.createElement("button");a.type="button",a.onclick=()=>{var e=document.getElementsByClassName("main")[0].innerHTML,t=(c(),d.isTalking&&(t=h?.state??"talk",a=h[t]["btn-"+o]??0,d.lastButtonPressed=o,h[t]["btn-"+o]=a+1),document.createElement("div")),a=(t.className="outPage",t.id="outPage",t.innerHTML=e,document.getElementsByClassName("topRoot")[0]);a&&a.appendChild(t),setTimeout(()=>{document.getElementById("outPage").remove(),window.scrollTo(0,0),m(),"function"==typeof n?n():I(n),y(),!d.buttonCount&&d.lastNode&&f("➜",()=>{d.lastNode&&d.lastNode()}),u()},650)},a.className="button",a.innerHTML=`<div class='buttonText'>${l(o,!0)}</div>`,e?t.prepend(a):t.appendChild(a)},s=e=>e[0].toUpperCase()+e.slice(1);const r=e=>(e=e||d.isTalking,w(e)?[d[e].name,"","",""]:[d[e].name,"a","the","that"]),p=(e,t)=>{t=t||d.isTalking,d[t].name=e},w=e=>(e=e||d.isTalking,d[e].hasMet);const g=(e,t)=>{e=e??"talk";t=t||d.isTalking,d[t].state=e,d.isTalking===t&&(d.lastNode=d[t][e])},b=e=>{return e=e||d.currentLocationName,d[e].visited??0};const v=(e,t)=>{f(e,()=>{t?(t(),f("➜",()=>{C(d.currentLocationName)(),d.isTalking=""})):(C(d.currentLocationName)(),d.isTalking="")})};const k=(o,n)=>{var e=document.getElementById("btns");if(e&&o&&n){d.buttonCount||(d.buttonCount=0),d.buttonCount+=1,o=o.trim();var t=document.createElement("form");const s=document.createElement("input");var a=document.createElement("input"),i=document.createElement("div");t.className="inputForm",t.action="javascript:void(0)",t.onsubmit=e=>{e.preventDefault(),r()},i.className="inputLabel",i.innerHTML=l(o),s.type="text",s.action="javascript:void(0)",s.enterkeyhint="go",s.className="inputString",a.action="javascript:void(0)",a.type="submit",a.className="submit",a.hidden=!0,a.onclick=e=>{e.preventDefault(),r()};const r=()=>{var e=document.getElementsByClassName("main")[0].innerHTML,t=(c(),d.isTalking&&(t=h?.state??"talk",a=h[t]["btn-"+o]??0,d.lastButtonPressed=o,h[t]["btn-"+o]=a+1),document.createElement("div")),a=(t.className="outPage",t.id="outPage",t.innerHTML=e,document.getElementsByClassName("topRoot")[0]);a&&a.appendChild(t),setTimeout(()=>{document.getElementById("outPage").remove(),window.scrollTo(0,0),m();var e=s.value.toLowerCase().replace(/\s/g,"");n(e),y(),!d.buttonCount&&d.lastNode&&f("➜",()=>{d.lastNode&&d.lastNode()}),u()},450)};t.appendChild(i),t.appendChild(s),t.appendChild(a),e.appendChild(t)}},I=e=>{var t=document.getElementById("page");if(t)if(Array.isArray(e)){var a=e;const s=a[0];var o="i"+(()=>{let e=0;if(0!=s.length)for(i=0;i<s.length;i++){var t=s.charCodeAt(i);e=(e<<5)-e+t,e&=e}return e})(),n=d[o]??0;n?(I(a[n]),n<a.length-1&&(d[o]=n+1)):(d[o]=1,I(s))}else"string"==typeof e?t.innerHTML+=l(e):"function"==typeof e&&(t.innerHTML+=l(e()))},T=e=>{var t,a=document.getElementById("page");a&&((t=document.createElement("div")).className="spacedMsg",t.innerHTML=l(e,!0),a.appendChild(t))},C=t=>{const a=()=>{Object.keys(d).map(e=>{var t,a;d[e]?.location&&d.currentLocationName===d[e]?.location&&(t=(e=>{e=e||d.isTalking;var[t,,a]=r(e),o=d[e].state??"talk";if(!w(e)&&d[e].notMet){if("function"==typeof d[e].notMet)return d[e].notMet();if("object"==typeof d[e].notMet&&d[e].notMet[o]){if("function"==typeof d[e].notMet[o])return d[e].notMet[o]();if("string"==typeof d[e].notMet[o])return d[e].notMet[o]}return d[e].notMet??s(a+` ${t} is here.`)}if("function"==typeof d[e].desc)return d[e].desc();if("object"==typeof d[e].desc&&d[e].desc[o]){if("function"==typeof d[e].desc[o])return d[e].desc[o]();if("string"==typeof d[e].desc[o])return d[e].desc[o]}return d[e].desc??s(a+` ${t} is here.`)})(e),I(t),d[e].talk)&&f((e=>{e=e||d.isTalking;var[t,,a,,]=r(e);return d[e].talkLabel?"string"==typeof d[e].talkLabel?d[e].talkLabel:d[e].talkLabel():`Talk to ${a} `+t})(e),(a=e,()=>{d.isTalking=a,(h=d[a]).hasMet=!0;var e=h?.state??"talk";1!==d?.map?.length||d.showFastTravelTip||(d.showFastTravelTip=1),d[a][e](),d.lastNode=d[a][e]}),!0)})};return()=>{d.currentLocationName=t;var e=()=>{var e=d[t]?.visited??0;d.env=null,d.isTalking="",d[t](),a(),d[t].visited=e+1,1===d.showFastTravelTip&&d[d.map[0]].location!==d.currentLocationName&&(d.showFastTravelTip=2,x("Hey there! You can now fast travel to characters you meet by tapping the top ⤴ of the screen"))};e(),d.lastNode=e}};const B=e=>{var t=`p{${o(e.join("-"))}}`;return d[t]&&d[t]?.length||(d[t]=(e=>{let t=e.length,a;for(;0!=t;)a=Math.floor(Math.random()*t),t--,[e[t],e[a]]=[e[a],e[t]];return e})([...e])),d[t].pop()},x=e=>{const t=document.createElement("div");t.className="tipBox",t.id="tipBox";var a=document.createElement("div"),o=(a.className="tipInnerBox",a.id="tipInnerBox",document.createElement("div"));o.className="tipInnerText",o.id="tipInnerText",o.innerText=e,a.appendChild(o),t.appendChild(a),t.onclick=()=>t.remove(),document.body.appendChild(t)},H=e=>(d.values||(d.values={}),d.values[e]??!1),S=(e,t)=>{d.values||(d.values={}),d.values[e]=t};