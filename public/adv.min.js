function cmd(e,o){game.directionsReversed&&("left"===e?e="right":"right"===e?e="left":"up"===e?e="down":"down"===e&&(e="up")),Array.isArray(e)?e.map(e=>cmd(e,o)):game.commands[e.toLowerCase()]=o}function stringToHash(e){var o=0;if(0!=e.length)for(i=0;i<e.length;i++)o=(o<<5)-o+(char=e.charCodeAt(i)),o&=o;return o}function intro(){bigSpacer(),msg("Welcome Adventurer to"),msg("Steal 10 Treasures to Win This Game","title"),spacer(),msg("a game by spaceflounder"),msg("Press ~? if playing for first time!"),spacer()}function msg(e,o){var t,a=document.getElementById("con");a&&((t=document.createElement("div")).className=o||"sep",e=[(lst=e.split("~")).shift(),...lst.map(e=>{return[`<span class="key">${e.slice(0,1)}</span>`,e.slice(1)].join("")})].join(""),t.innerHTML=e,a.append(t),window.scrollTo(0,a.scrollHeight))}function spacer(){msg("","spacer")}function bigSpacer(){msg("","big-spacer")}function clear(){var e=document.getElementById("con");e&&(e.innerHTML="")}function msu(){if(!game.music&&game.musicToggle){const e=["First Snow","Dreams","Plants","Ramen","Endless Grind","Day Trips"];game.track=0,game.music=new Audio(`HoliznaCC0 - ${e[game.track]}.mp3`);setTimeout(()=>{game.music.play(),game.music.addEventListener("ended",()=>{game.track+=1,game.track===e.length&&(game.track=0),game.music.src=`HoliznaCC0 - ${e[game.track]}.mp3`,game.music.load(),setTimeout(()=>{game.music.play()},2e3)},!1)},3e3)}}Game.items.chowderSign={shortDesc:"festive sign",initialLocation:"scullery",desc:"A festive sign 🪧 is posted here. It reads: “Castle Chowder Festival — Down Stairs.” It appears to be a bit loose on the wall.",h:["give me a hint will you","This sign 🪧 isn't nailed down."],inv:e=>"chowderSign"!==game.item?["remove the festive sign 🪧 from the wall and take it",()=>{"smellyRoom"===game.location?msg("The sign 🪧 is stuck where it is."):(takeItem("chowderSign"),"diningHall"===game.things.chowderFestival.location&&(msg("It sounds like they're packing up that festival downstairs to go somewhere else."),game.things.chowderFestival.location=""),refresh())}]:["post the "+e.shortDesc,()=>{"toolRoom"===game.location?msg("There's no place on the wall to post the sign."):(dropItem("chowderSign"),"smellyRoom"===game.location&&(msg(`A great and terrible roar echoes from down the stairs, as if a huge and murderous beast had been 
  ...
  below. A narrow window overlooks a charming rose garden far below the castle wall.`),setExitsHeader(["left","right"]),cmd("h",["hint","This room could use some pepper."]),cmd(["up","down"],["walk into wall","Your nose is slightly bent following the attempt."]),cmd("s",["smell drafty room","It smells windy."]),cmd("l",["lick drafty room","You can't lick the wind."]),cmd("f",["feel air","The air is blowing rapidly down into the opening in the floor."]),cmd("c",["climb down chain",()=>go("dragonRoost")]),game.pepper&&cmd("g",["grind pepper",()=>{msg("Great clouds of pepper drift on the air currents down into the opening in the floor."),msg("ACHOOO!"),msg("A firey blast escapes the chamber below! Someone down there can't handle a little pepper in the air!"),"roseGarden"===game.things.rubyRose.location&&game.dragonValve&&(msg(`Through the window, you can make out a bit of flame dancing in the rose garden. It would 
          appear that your actions have managed to scorch a few bushes.`),game.things.rubyRose.location="",game.things.scorchedRubyRose.location="roseGarden",addScore(3),refresh())}]),cmd("right",["enter the maze entrance",()=>go("mazeEntrance")]),cmd("left",["enter scullery",()=>go("scullery")])},Game.rooms.dragonCave=()=>{header("Dragon Cave"),desc("In the shadows is a narrow opening lit by a hot orange glow. Above the opening is very ominous-looking sign 🪧 in gothic lettering."),setExitsHeader(["up","down"]),cmd(["left","right"],["I want to walk into a cave wall","You resist the urge to smack straight into a cave wall."]),cmd(["r","x"],["read sign","The sign 🪧 reads: “Stop grinding pepper in the dragon's roost, you idiots!”"]),cmd("s",["smell cave","Like fire and old limestone."]),cmd("l",["lick dragon cave (with tongue)","It tastes hot and stony."]),cmd("f",["feel cave","You're the touchy-feely type, aren't you?"]),cmd(["down","i"],["enter the roost",()=>go("dragonRoost")]),cmd("up",["leave the dragon pen",()=>go("clamRoom")])},Game.rooms.dragonRoost=()=>{header("Dragon Roost"),desc(`A vast underground cavern is lit by the gentle orange breath of a massive dragon, big as a football field.
